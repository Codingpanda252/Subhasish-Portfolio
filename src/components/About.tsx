...
const About = () => (
  <section id="about" className="py-24 px-6 relative overflow-hidden">
    ...
    <div className="max-w-6xl mx-auto relative z-10">
      <h2 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-center mb-16 bg-gradient-to-r from-yellow-300 via-pink-400 to-purple-400 bg-clip-text text-transparent drop-shadow-[0_0_10px_rgba(255,255,255,0.3)]">
        About Me
      </h2>

      <div className="grid md:grid-cols-2 gap-12 items-center">
        <div className="flex flex-col items-center gap-6 w-full">
          <div className="relative w-40 h-40 sm:w-48 sm:h-48 rounded-full overflow-hidden border-4 border-purple-400 shadow-xl group">
            <img
              src="/subhasish.png"
              alt="Subhasish Panda"
          ...
          <div className="w-full h-80 sm:h-[22rem] md:h-[26rem] rounded-3xl overflow-hidden shadow-2xl border border-white/20 bg-black/20">
        ...
        <div className="bg-white/10 backdrop-blur-lg p-6 sm:p-10 md:p-12 rounded-3xl border border-white/20 shadow-2xl text-white/90 text-base sm:text-lg leading-relaxed space-y-8">
          <p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-8 text-center">
            <div className="flex flex-col items-center">
              ...
              <span className="text-lg font-semibold text-purple-300">12+ Hackathons</span>
              <p className="text-sm text-white/80">National & International Level</p>
            </div>
            <div className="flex flex-col items-center">
              <Users className="text-pink-300 mb-2" size={36} />
              <span className="text-lg font-semibold text-pink-300">Community Builder</span>
              <p className="text-sm text-white/80">500+ Students Impacted</p>
            </div>
            <div className="flex flex-col items-center">
              <Lightbulb className="text-yellow-300 mb-2" size={36} />
              <span className="text-lg font-semibold text-yellow-300">Innovator</span>
