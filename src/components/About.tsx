    ...
    <div className="max-w-6xl mx-auto relative z-10">
      ...
      <div className="flex flex-col-reverse md:grid md:grid-cols-2 gap-12 items-center">
        <div className="flex flex-col items-center space-y-8 w-full">
          <div className="avatar-flip mx-auto">
            <img src="/subhasish.png" alt="Subhasish Panda" />
            <img src="/avatar.png" alt="Avatar" />
          </div>

          <div className="w-full h-[22rem] md:h-[26rem] rounded-3xl overflow-hidden shadow-2xl border border-white/20 bg-black/20">
        ...
        <div className="bg-white/10 backdrop-blur-lg p-8 md:p-12 rounded-3xl border border-white/20 shadow-2xl text-white/90 text-lg leading-relaxed space-y-8 w-full">
          <p>
